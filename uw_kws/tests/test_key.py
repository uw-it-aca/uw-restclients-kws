...
class KWSTestKeyData(TestCase):
    def test_key_by_id(self):
        ...
        self.assertEqual(key.algorithm, 'AES128CBC', 'Correct algorithm')
        self.assertEqual(key.cipher_mode, 'CBC', 'Correct cipher mode')
        self.assertEqual(
        ...
        self.assertEqual(key.key, 'Uv2JsxggfxF9OQNzIxAzDQ==', 'Correct key')
        self.assertEqual(key.size, 128, 'Correct key size')
